...
int handle_print_args(const char *fmt, int *i, va_list list, char buffer[],
...
int write_number(int is_positive, int ind, char buffer[],
		 int flags, int width, int precision, int size);
int write_numb(int ind, char buffer[], int flags, int width,
	       int precision, int length, char padd, char extra_c);
int write_mem_addr(char buffer[], int ind, int length, int width,
